CREATE OR REPLACE FUNCTION util_meta._boolean_casting (
...
WITH args AS (
    SELECT util_meta._resolve_parameter ( 'a_cast_booleans_as'::text, a_cast_booleans_as ) AS cast_booleans_as
),
base AS (
