CREATE OR REPLACE FUNCTION util_meta._table_noun (
...
AS $$
/* *
Function _table_noun guesses at the proper "noun" for a table, view, or materialized view
...
BEGIN
    ...
    l_base_schema := util_meta._base_name ( a_ddl_schema ) ;
