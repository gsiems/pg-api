CREATE OR REPLACE FUNCTION util_meta._find_view (
...
AS $$
/* *
Function _find_view searches for an existing view for a table.
...
BEGIN
    ...
    l_view_name := util_meta._view_name ( a_table_name ) ;
