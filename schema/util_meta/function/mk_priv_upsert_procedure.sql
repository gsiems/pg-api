CREATE OR REPLACE FUNCTION util_meta.mk_priv_upsert_procedure (
...
BEGIN
    ...
    l_proc_name := 'priv_upsert_' || util_meta._to_singular ( l_table_noun ) ;
    ...
    FOR r IN (
        ...
        IF r.column_name IS NOT NULL THEN
            ...
            IF NOT ( r.is_audit_col AND r.audit_action = 'insert' ) THEN
