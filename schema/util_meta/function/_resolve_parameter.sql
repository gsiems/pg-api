CREATE OR REPLACE FUNCTION util_meta._resolve_parameter (
...
AS $$
/* *
Function _resolve_parameter checks/resolves a calling parameter and returns the parameter value.
