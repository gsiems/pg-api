...
DESCRIPTION
    ...
    Wrapper for the util_meta.mk_api_procedure DDL generation function
...
OPTIONS
    ...
    -a, --action action
        ...
        The action that the generated procedure should perform {insert, update, upsert, delete}
    ...
    -g, --grantees role_name[,role_name[,role_name...]]
        ...
        The (optional) csv list of roles that should be granted execute on the procedure
