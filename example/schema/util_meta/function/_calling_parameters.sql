CREATE OR REPLACE FUNCTION util_meta._calling_parameters (
...
AS $$
/* *
Function _calling_parameters returns the calling parameter data for the specified function/procedure
