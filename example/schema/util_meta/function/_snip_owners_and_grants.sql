CREATE OR REPLACE FUNCTION util_meta._snip_owners_and_grants (
...
AS $$
/* *
Function _snip_owners_and_grants generates the pl/pg-sql code snippet for setting ownership and granting execute
...
BEGIN
    ...
    l_owner = util_meta._resolve_parameter ( 'a_owner'::text, a_owner ) ;
